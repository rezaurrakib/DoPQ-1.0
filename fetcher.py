...
#set up logging
LOG_FILE = os.path.join(log_dir,"ContainerFetcher.log")
...
while 1:
    ...
    if len(network_containers) == 0: continue
    
    #get filesizes of the network containers
    network_containers_sizes = [os.stat(os.path.join(network_dir,container)).st_size for container in network_containers]
